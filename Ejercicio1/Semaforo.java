...
public class Semaforo {
    ...
    private final List<Character> letras = new ArrayList<Character>();//ArrayList donde se almacenarÃ¡n los carácteres del buffer
    public synchronized void accesoLeer() {
        if (libre && letras.size() > 0) { //Si el estado esta libre y el tamaÃ±o del buffer es mayor a 0 recogemos un carácter
